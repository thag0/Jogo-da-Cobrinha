...
public class Logica{
   ...
   public void gerarFruta(PainelJogo painelJogo){
      ...
      do{
         ...
         for(contador = 0; contador < painelJogo.cobrinha.size()-1; contador++){
            if(no.hitbox.intersects(painelJogo.cobrinha.get(0).hitbox)){
               colidindo = true;
               break;
            }
         }
   ...
   public void rodarJogo(PainelJogo painelJogo, LeitorTeclado leitorTeclado, Som som, InterfaceDesenho interfaceDesenho){
      ...
      if(leitorTeclado.wPressionado) painelJogo.direcao = "cima";
      else if(leitorTeclado.aPressionado) painelJogo.direcao = "esquerda";
      else if(leitorTeclado.sPressionado) painelJogo.direcao = "baixo";
      else if(leitorTeclado.dPressionado) painelJogo.direcao = "direita";
